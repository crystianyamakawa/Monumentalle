...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { created_by: @produto.created_by, descricao: @produto.descricao, obs: @produto.obs, updated_by: @produto.updated_by, valor: @produto.valor }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { created_by: @produto.created_by, descricao: @produto.descricao, obs: @produto.obs, updated_by: @produto.updated_by, valor: @produto.valor }
    assert_redirected_to produto_path(assigns(:produto))
  end
