...
RSpec.describe fornecedorsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all fornecedors as @fornecedors" do
      ...
      expect(assigns(:fornecedors)).to eq([fornecedor])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved fornecedor as @fornecedor" do
        post :create, {:fornecedor => invalid_attributes}, valid_session
        expect(assigns(:fornecedor)).to be_a_new(Fornecedor)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested fornecedor" do
        fornecedor = Fornecedor.create! valid_attributes
        put :update, {:id => fornecedor.to_param, :fornecedor => new_attributes}, valid_session
        fornecedor.reload
    ...
    context "with invalid params" do
      it "assigns the fornecedor as @fornecedor" do
        fornecedor = Fornecedor.create! valid_attributes
        put :update, {:id => fornecedor.to_param, :fornecedor => invalid_attributes}, valid_session
        expect(assigns(:fornecedor)).to eq(fornecedor)
      end
